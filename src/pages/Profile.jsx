...
import { User, Camera, Save, Ruler, Weight, Calendar, Loader2, Image as ImageIcon } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg p-6 border border-white/20">
        ...
        <div className="flex items-center gap-6">
          <div className="relative flex-shrink-0">
            {uploading ? (
              <div className="w-24 h-24 rounded-full bg-gray-100 border-4 border-teal-500 shadow-lg flex items-center justify-center">
              ...
              <div className="w-24 h-24 rounded-full bg-gradient-to-r from-teal-500 to-blue-500 flex items-center justify-center border-4 border-teal-500 shadow-lg">
            ...
            <button
              ...
              disabled={uploading}
              className={`absolute bottom-0 right-0 p-2 bg-white rounded-full shadow-lg cursor-pointer hover:bg-gray-100 transition-all ${
      ...
      {showImageSourceModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-xl p-6 max-w-sm w-full border border-white/20 transition-opacity">
